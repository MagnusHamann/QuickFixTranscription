...
The setup/launch scripts may download the default local Whisper model into `models/ggml-base.bin`. Verify downloaded models by checksum before use. Do not add any cloud transcription fallback.
